...
import { cancelJob, completeJob, deleteJob } from '../../../services/jobs.service.js';
...
export function JobHeader({ job, onEdit, onChanged, onDeleted }) {
  ...
  async function handleCancel() {
    ...
    try {
      ...
      toast(error.response?.data?.message || 'Could not cancel job');
    }
  }
  ...
  async function handleDelete() {
    ...
    try {
      ...
      toast(error.response?.data?.message || 'Could not delete job');
    }
  }
