...
function cacheKey(params) {
  return `staff-jobs:${JSON.stringify(params)}`;
}
...
export function useJobs(params) {
  ...
  }, [params.stage, params.priority, params.assigned, params.mine, params.due, params.search, params.page, params.customer, key]);
